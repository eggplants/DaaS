...
class JudgeEngine:
    ...
    def exec(self, text: str) -> bool:  # noqa: A003
        self.applied_rule = ""
    ...
    def __rec_judge(self, reading: str, morphs: list[str], is_tight: bool = False) -> bool:
        ...
        for method in methods:
            ...
            if conv_reading != reading and self.__rec_judge(conv_reading, conv_morphs, is_tight):
                return True
    ...
    def __conv_looped_vowel_to_hyphen(self, reading: str, morphs: list[str]) -> tuple[str, list[str]]:
    ...
    def __pass_full_match(self, reading: str, morphs: list[str], _is_tight: bool = False) -> bool:
    ...
    def __pass_vowel_match(self, reading: str, _morphs: list[str], is_tight: bool = False) -> bool:
        if is_tight:
            return False
    ...
    def __pass_consonant_match(self, reading: str, _morphs: list[str], is_tight: bool = False) -> bool:
        if is_tight:
            return False
        ...
        for ch1, ch2 in self.__text_to_char_pair(reading, 3):
            ...
            if self.__count_char_matches(ch1, ch2, True) < 2:
                continue
            if sorted([pyboin.convert_vowel(ch, "ア") for ch in ch1]) == sorted(
                [pyboin.convert_vowel(ch, "ア") for ch in ch2],
            ):
                return True
        return False

    def __pass_swap_match(self, reading: str, _morphs: list[str], is_tight: bool = False) -> bool:
        if is_tight:
            return False
    ...
    def __pass_magic_nn(self, reading: str, _morphs: list[str], is_tight: bool = False) -> bool:
        if is_tight:
            return False
